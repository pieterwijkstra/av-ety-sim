# AV ETY Simulation v6: multiple load ports (independently generated), varying discharge ports, multiple vessels (assigned by availability, order of creation)
import random
import pandas as pd
...
LOAD_PORTS = ["Rotterdam", "Nynashamn", "Tornio"]
VESSELS = ["Coral Alpha", "Coral Bravo"]
...
if __name__ == "__main__":
    ...
    vessels = [Vessel(name=name) for name in VESSELS]
